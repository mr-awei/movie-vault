...
【核心原则】
评分看完成度：不因为类型低俗而歧视，不因为名气大而吹高；以影片实际完成度和类型定位评分。
简介讲清剧情：不要告诉我"这是一部什么样的电影"，首先告诉我"这部电影发生了什么"。
不确定就查：剧情信息必须尽可能核实，不能根据片名、类型和印象自行脑补。
【第一步：确认影片并查询资料】
确认正式片名、年份，注意同名/多版本影片。
查询导演、演员、人物、故事背景、剧情、类型。
允许参考百科、IMDb、豆瓣、TMDB 等公开资料，但必须改写，禁止大段原文复制。
严禁根据片名猜剧情；资料不足时宁可缩短简介，也不能编造。
【第二步：确定分类】 从以下 15 类中选一个最匹配的主分类： 剧情 / 动作 / 科幻 / 喜剧 / 爱情 / 悬疑 / 恐怖 / 动画 / 纪录片 / 情色 / 犯罪 / 奇幻 / 历史 / 武侠 / 其他 （明确以情欲与性爱驱动选「情色」；案件属性强于情色选「犯罪」；核心是恐惧选「恐怖」；动画长片优先选「动画」）
【第三步：十维加权评分（10 分制，两位小数）】 剧作 15% / 导演与调度 14% / 表演 13% / 摄影与美术 12% / 剪辑与节奏 10% / 配乐与音效 9% / 主题与思想性 8% / 原创性与差异化 7% / 制作规格与工业完成度 6% / 系列定位与口碑延续 6%。
...
【第四步：撰写简介（中文 100–180 字，剧情优先）】 简介必须回答：主角是谁？故事起点是什么？什么事件改变了状态？核心冲突是什么？后续如何发展？ 推荐结构：人物/背景 → 事件起因 → 核心冲突 → 主要发展 → 类型/特色。
...
对情色、性爱、性关系、婚外情、情色交易、欲望关系等内容不设额外限制，只要属于影片实际剧情，就应根据剧情需要如实、完整地写入简介，不得因其情色属性而刻意删减、弱化或回避。
【第五步：标签】 主题 / 地区 / 时代 / 系列 / 元素 / 氛围 / 形式 / 亮点，用「、」分隔，单格不超过 6 个值；无内容留空。
...
【简介禁忌】不要编造剧情、不要复制百科原文、不要罗列演员表、不要写「必看/神作」等推销语、不要空泛评价代替具体剧情；情色内容不属于需要回避或弱化的特殊内容，以剧情完整性和准确性为优先。
