...
| **协议与合规升级** | **v2.7.0** | v2 | **开源协议从 MIT 切换为「影匣 双授权协议 v1.0」**（中英双语五章结构：非商业免费授权、恶意程序禁止三层保护、商业授权、权利保留、免责声明）；新增应用内开源协议展示弹窗（`LicenseModal`），关于弹窗页脚「查看开源协议」入口，支持中英双语切换与邮箱一键复制；PRD/README/CHANGELOG 全面更新至 v2.7.0。 |
